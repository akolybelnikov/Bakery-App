                    ...
                    {({formState}) => (
                        <Fragment>
                            ...
                            <Field>
                                ...
                                <p
                                    className="has-text-left is-size-7-mobile has-text-info"
                                    htmlFor="state-password">
                                    Пароль должен содержать:<br></br>
                                    - не менее 1 строчной буквы<br></br>
                                    - не менее 1 заглавной буквы<br></br>- не менее 1 цифры<br></br>- не менее 1 специального символа (!, @, #, $, %, ^, &)<br></br>и быть длинной не менее восьми знаков
                                </p>
                                <Control className="has-icons-right">
                                    <Text
                                        ...
                                        className="input"/>
                                    <span
                                        onClick={this.props.onAttributeToggle}
