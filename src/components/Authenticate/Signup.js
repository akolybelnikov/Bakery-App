...
const Signup = props => {
    const {handleSignUp, onFormChange, onAttributeToggle, attribute, busy} = props
    return (
            ...
            <Card>
                {!busy
                    ? <CardContent>
                            ...
                            <Field>
                                <Button isColor="primary" isOutlined isFullWidth onClick={handleSignUp}>Отправить</Button>
                            </Field>
                        </CardContent>
